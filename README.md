...
本项目90%以上为ai coding ，是一个vibe coding个人练习项目（项目处于初级阶段，接口未充分测试)

## 0. 开发动机
在币安学习现货合约操作时，最开始想用模拟盘练习，但它的模拟盘居然是私服，还是可以联机的私服，价格完全由模拟盘用户的操作决定，没有参考性。也找不到同类型的平台，就想自己用ai快速开发一个（现在感觉还是实盘练习更能锻炼心态🥲）
...
## 14. 声明
- 再次强调，项目处于初级阶段，接口未充分测试，运行时很可能出现报错
